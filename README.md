...
> Ullmann, T., Heinze, G., Kammer, M., Dunkler, D. for TG2 of the STRATOS initiative (2026). A preregistered simulation study provided evidence on the appropriate use of data-driven variable selection in descriptive multivariable regression modeling. *Journal of Clinical Epidemiology*, [112423](https://doi.org/10.1016/j.jclinepi.2026.112423).
...
The simulation result files (`results/`) are not included in this repository due to their size. They are bundled with the deployed apps. To obtain the results files, please contact the authors. The apps can then be run locally as follows:
